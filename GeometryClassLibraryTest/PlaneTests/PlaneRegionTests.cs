...
namespace GeometryClassLibraryTests
{
    ...
    public class PlaneRegionTests
    {
        ...
        public void PlaneRegion_Shift()
        {
            ...
            Arc arcToadd = new Arc(PointGenerator.MakePointWithInches(0, 0, 0), PointGenerator.MakePointWithInches(2, 3, 0), Direction.Right);
            ...
            Arc arcExpected = new Arc(PointGenerator.MakePointWithInches(2, 0, 0), PointGenerator.MakePointWithInches(4, 3, 0), Direction.Right);
