...
namespace GeometryClassLibraryTest
{
    ...
    public class PlaneRegionTests
    {
        ...
        public void PlaneRegion_Shift()
        {
            ...
            Arc arcToadd = new Arc(PointGenerator.MakePointWithInches(0, 0, 0), PointGenerator.MakePointWithInches(2, 3, 0), new Direction());
            ...
            Arc arcExpected = new Arc(PointGenerator.MakePointWithInches(2, 0, 0), PointGenerator.MakePointWithInches(4, 3, 0), new Direction());
