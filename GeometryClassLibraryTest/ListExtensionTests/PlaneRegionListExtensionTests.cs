...
namespace GeometryClassLibraryTest
{
    ...
    public class PlaneRegionListExtensionTests
    {
        ...
        public void PlaneRegion_ShiftList()
        {
            ...
            Arc arcToadd = new Arc(PointGenerator.MakePointWithInches(0, 0, 0), PointGenerator.MakePointWithInches(2, 3, 3), Direction.Right);
            ...
            Arc arcExpected = new Arc(PointGenerator.MakePointWithInches(0, 0, 0), PointGenerator.MakePointWithInches(2, 3, 3), Direction.Right);
