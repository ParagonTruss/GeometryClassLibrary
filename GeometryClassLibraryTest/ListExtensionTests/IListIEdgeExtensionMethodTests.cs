...
namespace GeometryClassLibraryTest
{
    ...
    public class IListIEdgeExtensionMethodTests
    {
        ...
        public void IEdge_ShiftTest()
        {
            ...
            edges.Add(new Arc(PointGenerator.MakePointWithInches(5,4,0), PointGenerator.MakePointWithInches(2,-1,0), new Direction()));
            ...
            (results.Contains(new Arc(PointGenerator.MakePointWithInches(7, 4, 0), PointGenerator.MakePointWithInches(4, -1, 0), new Direction()))).Should().BeTrue();
        }
    }
}
