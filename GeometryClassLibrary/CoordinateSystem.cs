...
namespace GeometryClassLibrary
{
    ...
    public class CoordinateSystem
    {
            ...
            Enums.Axis whichAxisIsPassed = Enums.Axis.X, Enums.AxisPlanes whichAxisPlaneIsPassed = Enums.AxisPlanes.XYPlane)
        {
            ...
            //Vector normalAxis = new Vector(axisInPassedPlaneToUseAsBase.BasePoint, planeContainingTwoOfTheAxes.NormalVector.Direction, new Dimension(DimensionType.Inch, 1));
            ...
            switch (whichAxisPlaneIsPassed)
            {
                case Enums.AxisPlanes.XYPlane:
                    zAxis = new Vector(axisInPassedPlaneToUseAsBase.BasePoint, planeContainingTwoOfTheAxes.NormalVector.Direction, new Dimension(DimensionType.Inch, 1));
                ...
                case Enums.AxisPlanes.XZPlane: 
                    yAxis = new Vector(axisInPassedPlaneToUseAsBase.BasePoint, planeContainingTwoOfTheAxes.NormalVector.Direction, new Dimension(DimensionType.Inch, 1));
                    switch (whichAxisIsPassed)
                    {
                ...
                case Enums.AxisPlanes.YZPlane:
                    xAxis = new Vector(axisInPassedPlaneToUseAsBase.BasePoint, planeContainingTwoOfTheAxes.NormalVector.Direction, new Dimension(DimensionType.Inch, 1));
                    switch (whichAxisIsPassed)
                    {
                        //the axis must be in the plane we were passed
                        case Enums.Axis.X:
            ...
            xAxis = xAxis.Direction.UnitVector(DimensionType.Inch);
            yAxis = yAxis.Direction.UnitVector(DimensionType.Inch);
            zAxis = zAxis.Direction.UnitVector(DimensionType.Inch);
            ...
            Dimension dotProductOfZAndNormal = zAxis * planeContainingTwoOfTheAxes.NormalVector.UnitVector(DimensionType.Inch);
