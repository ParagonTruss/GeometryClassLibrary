...
namespace GeometryClassLibrary
{
    ...
    public class RectangularPrism : Polyhedron
    {
        ...
        /// </summary>
        public RectangularPrism(Distance length, Distance width, Distance height) : base(_makeFaces(length, width, height)) { }
        
        private static List<Polygon> _makeFaces(Distance length, Distance width, Distance height)
        {
